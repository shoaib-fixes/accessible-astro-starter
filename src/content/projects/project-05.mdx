...
FinanceForAll revolutionises personal banking by making financial tools accessible to everyone. The platform provides screen-reader optimised interfaces, keyboard-only navigation, and simplified layouts for cognitive accessibility, ensuring equal access to banking, investment, and financial planning tools.
...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
  ...
  <Image
    ...
    alt="Screen-reader optimised investment charts"
    width={1200}
    height={600}
    class="h-[250px] w-full rounded-lg object-cover"
  />
